...
## Что выбрать: поиск по ключевым словам или поиск похожих каналов

| Если задача такая | Лучше использовать |
|---|---|
| Ниша еще не разобрана и нужно начать с нуля | [Поиск каналов и групп](https://github.com/Deskgram-2/telegram-channel-search-deskgram) |
| Уже есть несколько сильных площадок и нужно расширить карту источников | [Поиск похожих каналов](https://github.com/Deskgram-2/telegram-similar-channels-deskgram) |
| Нужен discovery-маршрут в две стадии | Сначала поиск по ключам, потом поиск похожих |
| Нужно только быстро накидать первичный список площадок | Поиск по ключевым словам |

## FAQ для рабочих сценариев

### Когда лучше идти дальше в сбор аудитории, а когда в поиск похожих каналов?

Если уже нашли достаточно хороших площадок и хотите получить пользователей, логично переходить в [сбор аудитории](https://github.com/Deskgram-2/telegram-audience-parser-deskgram). Если хорошие seed-источники есть, но карта ниши все еще узкая, лучше сначала расширить ее через [поиск похожих каналов](https://github.com/Deskgram-2/telegram-similar-channels-deskgram).

### Для каких задач этот модуль особенно полезен как первый шаг?

Для входа в новую нишу, первичного discovery, подготовки списка источников под парсинг и в любых сценариях, где сначала нужно найти сами площадки, а не сразу работать с аудиторией.

### Что чаще всего влияет на качество выдачи?

Качество кластера ключевых слов, уместность фильтрации и то, есть ли у вас понятный следующий шаг после discovery: расширение карты, сбор базы или коммуникация.
